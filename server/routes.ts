  ...
  async function seedDatabase() {
    ...
    if (!existingInfo) {
      ...
      await storage.createProject({
        ...
        fullDescription: "Created a BOQ generation platform from scratch. Integrated advanced libraries for interactivity and professional functionality.",
      ...
      await storage.createProject({
        ...
        fullDescription: "Built a frame-selling platform with Next.js & Tailwind CSS. Integrated PhonePe for payments and Cloudinary for image storage.",
      ...
      await storage.createProject({
        ...
        fullDescription: "Developed complete frontend using React & Tailwind CSS with smooth animations. Built responsive landing pages and login system.",
      ...
      await storage.createProject({
        ...
        fullDescription: "Enhanced UI, fixed bugs, and optimized performance using React (TypeScript) & Tailwind CSS.",
      ...
      await storage.createSkill({
        ...
        items: ["Java", "C", "C++", "Python", "C#", "JavaScript", "HTML", "CSS", "TypeScript"]
      });

      await storage.createSkill({
        category: "Frameworks & Libraries",
        items: ["React", "Vite", "Tailwind", "Bootstrap", "Angular", "Node.js", "Express.js", "Next.js", "Three.js", "GSAP"]
      });
