        ...
        <div className="container-custom relative z-10 flex flex-col items-center text-center">
          ...
          >
            <span className="px-4 py-2 rounded-full bg-secondary/80 border border-border text-sm font-medium text-muted-foreground inline-block mb-6 backdrop-blur-sm">
              Hello, I'm {personalInfo?.name || "Sunny Bandre 23456"}
            </span>
          </motion.div>
          ...
          >
            ...
            <span className="text-foreground/60 text-lg">
              Creating high-performance digital solutions with modern technology
              stacks.
            </span>
          </motion.p>
      ...
      <section id="about" className="py-24 bg-muted/30">
        <div className="container-custom">
          <SectionHeading
            ...
            subtitle="My technical toolkit and areas of focus"
          />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                {personalInfo?.bio ||
                  "I am a dedicated developer with a strong foundation in building scalable web applications. I love solving complex problems and turning ideas into reality through code."}
              </p>
          ...
          <div className="max-w-4xl mx-auto">
            {experience?.map((exp, index) => (
              ...
              >
                ...
                <div
                  className={`md:flex items-center justify-between mb-12 relative ${index % 2 === 0 ? "md:flex-row-reverse" : ""}`}
                >
                  {/* Timeline Dot */}
                  ...
                  {/* Date (Desktop side) */}
                  <div
                    className={`hidden md:block w-[45%] ${index % 2 === 0 ? "text-left" : "text-right"}`}
                  >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {!projects &&
              ...
              [1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="h-96 rounded-2xl bg-card border border-border animate-pulse flex flex-col overflow-hidden"
                >
